...
Read the root `AGENTS.md` (at `../../AGENTS.md` relative to this subproject inside `src/`) before working here.
...
- **Use the project's package manager** — never run tools bare; always use the configured runner (e.g., `uv run`, `npm run`, `cargo`)
